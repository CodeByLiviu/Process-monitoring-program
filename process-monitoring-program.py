...
before you hit the start button you need a excel file to store all informations.                        
1. Choose the folder where the excel file will be!
2. Create an excel file inside the chosen folder and name it, the excel file must end with the extension .elsx, for example: RaportStatus.elsx.
...
4. Save the excel file, exit, and copy the path to the excel file! exemple: path = 'C:/Users/Liviu/Desktop/data/StatusReport.xlsx'
5. Start the program 
6. Choose the interval(seconds) between updates, it must be a integer number!
6. Choose the PID, you can find it in taskmanager (windows system), in section "Details", PID must be an integer!
full exemple: interval = 5, pid = 6060, path = 'C:/Users/Liviu/Desktop/data/StatusReport.xlsx' 
...
# while the program is running don't open excel file!
